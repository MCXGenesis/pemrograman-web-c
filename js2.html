...
<html>
    <head>
        ...
        <script type="text/javascript">
        	function hello() 
            {
        		alert("Lokasi baru: Jawirkarta, Ngawi, Bogor, Jomokerto, Pornorogo, Balikpantat, Silitiga, Sukiharjo");
        	}
            ...
            if (nrp.length != 10 && isNaN(nrp)){
                ...
                swal("Ada yang kosong nih!", "NRP harus 10 digit dan angka!", "error");
            ...
            if (nama.length == 0){
                ...
                swal("Ada yang kosong nih!", "Nama harus diisi!", "error");
